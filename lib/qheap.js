 ...
 * run 4x faster; v4, v5 and v6 run faster without it if testing with _isBefore
 * as opposed to _compar.
 *
...
Heap.prototype._check = function Heap__check( ) {
    ...
    for (i=this.length; i>1; i--) {
        ...
        p = i >>> 1;
        if (this._compar(p, i) > 0 && this._compar(i, p) < 0) fail = i;
    }
